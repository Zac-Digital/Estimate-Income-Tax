...
public sealed class OnGetJourneyValidatorTests
{
    ...
    public void IsValid_When_Stage_HowManyHoursWorked_IsValid_Returns_True_With_NoRedirect()
    {
        ...
        bool isValid =
            _onGetJourneyValidator.IsValid(nameof(JourneyStage.HowManyHoursWorked), out string? redirectPage);
    ...
    public void IsValid_When_Stage_StatePension_IsNotValid_Returns_False_With_Redirect(string? salary,
    ...
    [InlineData("£100.10 a day", nameof(JourneyStage.HowManyDaysWorked))]
    [InlineData("£20.20 an hour", nameof(JourneyStage.HowManyHoursWorked))]
    public void IsValid_When_Optional_Stage_CheckAnswers_IsValid_Returns_True_With_NoRedirect(string salary,
        string optionalStage)
    {
        _accessor.HttpContext.Session.SetString(nameof(JourneyStage.Salary), salary);
    ...
    [Fact]
    public void IsValid_When_Stage_Invalid_Throws_Exception()
    {
        Assert.Throws<ArgumentOutOfRangeException>(() =>
            _onGetJourneyValidator.IsValid(Guid.NewGuid().ToString(), out string? _));
    }
}